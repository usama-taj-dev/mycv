...
describe('AuthService', () => {
  ...
  it('can create an instance of an auth service', () => {
    expect(service).toBeDefined();
  });

  it('creates a new user with as salted and hased password', async () => {
  ...
  it('throws if signin is called with an unused email', async () => {
    await expect(
      service.signin('asdfjkl@asdfkj.com', 'testpassword'),
  ...
  it('throws if an invalid password is provided', async () => {
    ...
    await expect(service.signin('asdf@asdf.com', 'wqeqweqwe')).rejects.toThrow(
      BadRequestException,
    );
  });
